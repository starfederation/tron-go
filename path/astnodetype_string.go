// generated by stringer -type jpASTNodeType; DO NOT EDIT
...
func (i jpASTNodeType) String() string {
	if i < 0 || i >= jpASTNodeType(len(_astNodeType_index)-1) {
		return fmt.Sprintf("jpASTNodeType(%d)", i)
	}
