...
func (*SchemaError) KeywordPath() []string {
	return nil
}

func (k *SchemaError) LocalizedString(p *message.Printer) string {
...
func (*EnumError) KeywordPath() []string {
	return []string{"enum"}
}

func (k *EnumError) LocalizedString(p *message.Printer) string {
	allPrimitive := true
loop:
...
func (*FormatError) KeywordPath() []string {
	return []string{"format"}
}

func (k *FormatError) LocalizedString(p *message.Printer) string {
